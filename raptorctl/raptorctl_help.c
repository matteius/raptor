...
const struct help_entry help_entries[] = {
	...
	{NULL, "<daemon> start                      Start daemon"},
	{NULL, "<daemon> stop                       Stop daemon (clean shutdown)"},
	...
	{"rod", "enable                               Enable OSD rendering"},
	{"rod", "disable                              Disable OSD (clear all regions)"},
	{"rod", "set-time-format <fmt>               Set time format (strftime)"},
	...
	{"rmr", "enable                               Enable recording"},
	{"rmr", "disable                              Disable recording (closes segments)"},
	{"rmr", "start                               Start motion clip"},
	{"rmr", "stop                                Stop motion clip"},
	{"rmr",
